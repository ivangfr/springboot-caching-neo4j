...
The goal of this project is to implement a simple application that handles restaurants. There are some endpoints to
manage cities where the restaurants are, others to manage restaurants and, finally, some endpoints to handle the restaurant
